...
const { droneExist, droneIsIdle } = require("app/middlewares");
...
router.post("/:id/load", [droneExist, droneIsIdle, validate(validations.droneLoad)], droneController.loadDroneWithMedications);
